...
public class Keys {
	...
	public static final int NUMKEYS = 20;
	
	public static boolean keyState[] = new boolean[NUMKEYS];
	public static boolean prevKeyState[] = new boolean[NUMKEYS];
	...
	public static int SPACE = 9;
	public static int BUTTON4 = 10;
	...
	public static void keySet(int i, boolean b) {
		...
		else if(i == KeyEvent.VK_F) keyState[BUTTON3] = b;
		else if(i == KeyEvent.VK_ENTER) keyState[ENTER] = b;
		else if(i == KeyEvent.VK_ESCAPE) keyState[ESCAPE] = b;
		else if(i == KeyEvent.VK_SPACE) keyState[SPACE] = b;
		else if(i == KeyEvent.VK_A) keyState[BUTTON4] = b;
	}
